...
export default function About() {
  ...
  return (
    <section id="about" className="bg-white py-24 print:py-8 relative overflow-hidden">
      {/* Subtle Background Pattern */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none print:hidden" style={{ backgroundImage: 'radial-gradient(#0f172a 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
      ...
      <div className="section-container relative z-10 print:py-0">
        <div className="mb-24 print:mb-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl print:text-base text-slate-700 leading-relaxed font-medium whitespace-pre-line max-w-4xl break-keep">
              {about.description}
            </p>
          </motion.div>
        </div>
          ...
          {about.points.map((point, i) => {
            ...
            return (
              <motion.div
                ...
                className="p-10 print:p-6 rounded-[2.5rem] print:rounded-2xl bg-white border border-slate-200 hover:shadow-2xl hover:shadow-accent/10 hover:border-accent/40 transition-all duration-500 group flex flex-col items-center text-center shadow-sm"
              >
                ...
                <p className="text-slate-700 leading-relaxed text-lg print:text-sm font-medium whitespace-pre-line">
                  {point.content}
                </p>
              </motion.div>
            );
